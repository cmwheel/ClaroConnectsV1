  ...
  return (
    <>
      ...
      <main className="bg-bg-base">
        <ResearchArticleHero
          eyebrow="Investment Deep Dive"
          title="Why EV Charging Is the Infrastructure Investment of the Decade"
          description="A $40-48B market today, headed to $200-400B+. Tesla is selling the picks and shovels."
          imageSrc="/images/ev-charging-article1.jpg"
        ...
        <div className="border-y border-black/5 bg-white">
          <div className="mx-auto max-w-7xl px-5 py-4 sm:px-6 md:px-12">
            <motion.div
      ...
      <RelatedArticles currentHref="/research/ev-charging-investment" />
      <Footer />
    </>
  );
}
